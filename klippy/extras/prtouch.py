...
class PRTouchCFG:
    def __init__(self, config):
        ...
        self.clr_noz_start_x = config.getfloat('clr_noz_start_x', default=0, minval=-2, maxval=1000)
        self.clr_noz_start_y = config.getfloat('clr_noz_start_y', default=0, minval=-2, maxval=1000)
